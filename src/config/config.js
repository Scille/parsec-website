export default {
  // Site Configuration
  site: {
    title: "Parsec Cloud", // Shared title for SEO and OpenGraph
    description:
      "Assurez la sécurité et la performance de votre système collaboratif tout en garantissant la conformité réglementaire du stockage de vos données dans le cloud",
    tagline: "Le cloud collaboratif certifié ANSSI pour vos données sensibles.", // Shared description for SEO and OpenGraph
    taglineSeparator: "", // default is " - "
    baseUrl: "https://parsec.cloud", // Base URL for the site and used in OpenGraph meta tags.
    logo: "/images/logo_row_blue.svg", // Path to the site's logo
    logoIcon: "/images/logo_icon_blue.svg", // Path to the site's logo icon
    logoWidth: "218px", // Used as <img> attribute for aspect ratio hint (CLS prevention)
    logoHeight: "37px", // Visual size is controlled via CSS (.logo class)
    ...
    favicon: {
      ...
      image: "/images/logo.svg", // Source image used by npm run generate-favicons
    },
  },
  // SEO Metadata
  ...
  seo: {
    ...
    robotsTxt: {
      ...
      disallow: [], // Disallow specific paths(e.g., ["/_astro/", "/cdn-cgi/"])
    },
    sitemap: {
      enable: true, // Enables or disables sitemap generation on site build
      exclude: [], // exclude all pages that include these folder names(e.g., "blog", "services")
    },
  },
  ...
  settings: {
    ...
    multilingual: {
      ...
      showDefaultLangInUrl: false, // Show default language in URL
    },
  ...
  opengraph: {
    ...
    ogTitle: "Parsec Cloud - Share your confidential data (CSPN-certified)",
