...
import CardGrid from "@/shortcodes/CardGrid.astro";
...
```jsx
<VideoInline src="/videos/test-video.mp4" provider="html5" />
```
...
import SectorsSection from "@/components/sections/SectorsSection.astro";
