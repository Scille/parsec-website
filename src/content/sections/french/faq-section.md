...
description: Tout ce que vous devez savoir — de ce que nous faisons à comment nous le faisons — dans une FAQ rapide.
  ...
  - label: "Téléchargement & Onboarding"
    ...
    list:
      ...
      - active: false
        ...
        content: |
          Oui, nos plans incluent le support multi-utilisateurs. Vous pouvez inviter des collègues et attribuer des rôles avec différentes permissions.
      - active: false
