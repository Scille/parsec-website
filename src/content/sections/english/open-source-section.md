---
enable: true
title: "Our solution is **open-source**"
description: "We chose to open our code because the future of cybersecurity relies on software transparency for the user."
button:
  label: "Contribute to the project"
  url: "https://github.com/Scille/parsec-cloud/blob/master/CONTRIBUTING.md"
  target: "_blank"
